...
df3 = pd.DataFrame(oldCol0 + oldCol1 + oldCol2 + oldCol3 + oldCol4 + oldCol5 + oldCol6
                   + oldCol7 + oldCol8, columns="A B C D E Box".split())
